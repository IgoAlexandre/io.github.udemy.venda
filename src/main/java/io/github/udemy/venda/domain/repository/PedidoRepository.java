...
public interface PedidoRepository extends JpaRepository<Pedido, Integer> {
    ...
    @Query("select p from Pedido p left join fetch p.itens where p.idPedido =:idPedido")
    Optional<Pedido> findByIdPedidoFetchItens(@Param("idPedido") Integer idPedido);
